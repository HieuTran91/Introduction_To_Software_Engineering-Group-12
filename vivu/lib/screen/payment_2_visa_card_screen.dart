...
class Payment2VisaCardScreen extends StatelessWidget {
  Payment2VisaCardScreen({Key? key}) : super(key: key);
  ...
  Widget _buildCardNumber(BuildContext context) {
    return Padding(
        padding: EdgeInsets.only(left: 4.h, right: 13.h),
          ...
          Align(
              ...
              child: Padding(
                  ...
                  child: Row(
                      ...
                      children: [
                        CustomImageView(
                            imagePath: ImageConstant.imgVisaRemovebgPreview,
                            height: 45.v,
                            width: 75.h),
                        Container(
                            height: 20.adaptSize,
